...
function cadastraQuestoes(){
    ...
    fetch("http://localhost:8080/bancoquestao/salvar",  // insira o endereço da sua api, se local, permaneça com o localHost, se na nuvem, utilize o endereço de lá
    {
        headers:{
...
function obterQuestoes(){
    ...
    fetch(`http://localhost:8080/bancoquestao/obterquestao?${params}`, // insira o endereço da sua api, se local, permaneça com o localHost, se na nuvem, utilize o endereço de lá
    {
        headers:{
            "Accept": "application/json",
            "Content-Type": "application/json"
